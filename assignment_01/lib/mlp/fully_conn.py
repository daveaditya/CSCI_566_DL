...
class TestFCReLU(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="tiny_flatten"),
            fc(15, 5, name="tiny_fc"),
            leaky_relu(name="tiny_lrelu")
            ########### END ###########
        )
...
class SmallFullyConnectedNetwork(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            fc(4, 30, init_scale=0.02, name="fc_1"),
            leaky_relu(name="lrelu_1"),
            fc(30, 7, init_scale=0.02, name="fc_2")
            ########### END ###########
        )
